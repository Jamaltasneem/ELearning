		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="#our-members">Developer</a></li>
         	...
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="programmingdemo.php">Notes</a></h3>
         				<p>
         					Here you will find all the lecture tutorials .
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the videos tutorials.
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find problem programs for practice and their implementation  which will improve your knowledge.
         				</p>
         			</div>
         		</div>
<!-- 
 ...
 -->
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div id="team-member text-center" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/amu.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Tasneem Jamal</h4>
							...
							<div class="team-member text-center">
								<img src="img/amu.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Tasneem Jamal</h4>
									<h4 class="team-member-designation"> Developer</h4>
									<ul class="social-list">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
									you can ask questions. I will try to solve your problem. 
								</p>
							...
							<?php } */ ?>
								...
								<!--<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												This is an online E-learning website <br>
